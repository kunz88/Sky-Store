...
namespace API.Controllers
{
    ...
    public class ProductsController : ControllerBase // estendiamo una classe controller base ereditandone il formato e i membri
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Product>>> GetProducts(){// il tipo di ritorno di questo metodo sarà un task
            // rendiamo la funzione asincrona quando interroghiamo il database
            return await _context.Products.ToListAsync(); // interrogo il database e mi faccio ritornare un lista di tutti i prodotti
