...
namespace API.Data
{
    // creo una classe per il seeding del database
    public static class DbInitializer // essendo statica possiamo utilizzarla senza instanziarla
    {
        ...
        {        
            ...
            // aggioungo i prodotti nel database Seeding!!
            foreach (var product in products)
            {
                context.Products.Add(product); 
            }
            context.SaveChanges(); // salvo i cambiamenti nella tabella nel database
        }
