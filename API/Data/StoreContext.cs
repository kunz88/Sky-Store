...
namespace API.Data
{
    public class StoreContext : DbContext // la classe deriva da una classe che si trova 
    //nel framework Entity chiamata DbContext
    {
        ...
        public DbSet<Basket> Baskets {get;set;} // reppresenta la tabella del carrello
    }
}